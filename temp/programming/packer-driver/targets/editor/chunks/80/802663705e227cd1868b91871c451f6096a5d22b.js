      ...
      _export("bgTransForm", bgTransForm = (_dec = ccclass('bgTransForm'), _dec(_class = class bgTransForm extends Component {
        moveBg() {
          ...
          for (let i of bgList) {
            ...
            i.setPosition(new Vec3(0, y, 0)); // if (bgList[i].position.y <= -1500) {
            // 	bgList[i].position.y = 1500
            // }
            // console.log(bgList[i].position.y, '000-=-=-=-=-=')
          }

          console.log(bgList[0].position.y, '==========');
        } // 1、先执行 - 首次加载
...
//# sourceMappingURL=802663705e227cd1868b91871c451f6096a5d22b.js.map